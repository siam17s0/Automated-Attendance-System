...
def teacher_tab_manage_subjects():
    ...
    with col2:
        if st.button("Create a New Subjects", width='stretch'):
...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder="sakib")
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder="sakib")
    teacher_name = st.text_input("Enter name", placeholder="Saadman Sakib")
